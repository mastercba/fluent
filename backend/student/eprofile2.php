...
<body>
    <header id="header">
        <div class="wrapper">
            <a href="/" class="logo"><img src="/fluent/backend/student/img/logo.png" alt="FluentSpeaking - Professional eLearning"></a>
                ...
                <td style="width:500px;"><!-- Basic Information -->
                    <div style="height:250px; width: 500px;">
                        ...
                        <div class="details">
                            ...
                            <div class="pfl_der">
                                <form action='sp2.php' onsubmit='return validate();' method = 'POST' id="form2">
                                    <ul class="lista_profile">
                                        ...
                                        <li><b>
                                                <input type="radio" name="nsgender" id="optionsRadios1" onchange='validate()' value="female">Female
                                                <input type="radio" name="nsgender" id="optionsRadios2" onchange='validate()' value="male"> Male
