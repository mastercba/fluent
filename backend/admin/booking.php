...
<!-- info basica -->
	...
	<section>
		...
		<article id="columna_izq">
			<div class="titul">	
				<tr><td><u>BOOKING INFORMATION </u></td>	
					<td>
						<a href="editbooking.php" ><img src="img/pencil.png" width="14" height="14"/></a>
					</td>
				</tr>	
			</div>
			<div class="subtitul">			
					<tr><td><h10>Booking Date :  </h10><h9><b><?=$_SESSION['snombre']?></b></h9></td></tr><br />
					<tr><td><h10>Language :  </h10><h9><b><?=$_SESSION['sapellido']?></b></h9></td></tr><br />
					<tr><td><h10>Training Form / Length :  </h10><h9><b><?=$_SESSION['sbirth']?></b></h9></td></tr><br />
					<tr><td><h10>Training Place :  </h10><h9><b><?=$_SESSION['sgender']?></b></h9></td></tr><br />
